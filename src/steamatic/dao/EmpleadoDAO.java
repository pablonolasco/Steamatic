...
public class EmpleadoDAO implements IEmpleado {
    ...
    private String SQL_INSERT = "Insert Into Empleado(Nombre,Apellido_Paterno,Apellido_Materno,Organismo,Sexo,Estado_Civil,Fecha_Nacimiento,Direccion,Puesto)"
            + "        Values(?,?,?,?,?,?,?,"
            + "               ?,?);";
    private String SQL_DELET = "";
    private String SQL_UPDATE = "";
    private String SQL_READ = "Select * from Empleado where ( Nombre like ? or Apellido_Paterno like ?);";
    private String SQL_READ_ALL = "Select * from Empleado;";
    ...
    @Override
    public int modificar_empleado(EmpleadoDTO edao) throws SQLException {
        throw new UnsupportedOperationException("Not supported yet."); //To change body of generated methods, choose Tools | Templates.
    }

    @Override
    public int eliminar_empleado(EmpleadoDTO edao) throws SQLException {
        throw new UnsupportedOperationException("Not supported yet."); //To change body of generated methods, choose Tools | Templates.
    }
