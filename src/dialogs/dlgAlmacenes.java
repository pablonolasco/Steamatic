 ...
 *
 */
public class dlgAlmacenes extends javax.swing.JDialog implements IMetodosFormulario {
    ...
    public dlgAlmacenes(java.awt.Frame parent, boolean modal, String tipo) {
        super(parent, modal);
        initComponents();
        this.tipo = tipo;
    ...
    private void obtener_almacenes() {
        try {
    ...
    private void jButton6ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton6ActionPerformed
        ...
        try {
            ...
            if (buscar.equalsIgnoreCase("")) {
                ...
                dTO.setmArticulo(buscar);
                model = new DefaultTableModel();
                model = iAlmacen.get_almacen(dTO);
        ...
        try {
            ...
            if (evt.getClickCount() == 1) {
                ...
                if (tipo.equals("d")) {
                    ...
                    String nombre = "Articulo:" + rSTableMetro1.getValueAt(rowIndex, 2).toString();
                    pnlDevolucion.lbl_nom_arti.setText(nombre);
                    pnlDevolucion.lbl_id_emp.setText(id);
                    pnlDevolucion.lbl_id_emp.validate();

                    //almacen.updateUI();
                    pnlDevolucion.id = id;
                    pnlDevolucion.stock_almacen = rSTableMetro1.getValueAt(rowIndex, 6).toString();
                    dispose();
                } else {
                    String id = rSTableMetro1.getValueAt(rowIndex, 1).toString();
                    String nombre = "Articulo:" + rSTableMetro1.getValueAt(rowIndex, 2).toString();
                    pnlSalida.lbl_nom_arti.setText(nombre);
                    pnlSalida.lbl_id_emp.setText(id);
                    pnlSalida.lbl_id_emp.validate();

                    //almacen.updateUI();
                    pnlSalida.id = id;
                    pnlSalida.stock_almacen = rSTableMetro1.getValueAt(rowIndex, 6).toString();
                    dispose();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(dlgAlmacenes.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                dlgAlmacenes dialog = new dlgAlmacenes(new javax.swing.JFrame(), true, "");
